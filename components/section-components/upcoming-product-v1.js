...
class UpcomingProductV1 extends Component {
	...
	render() {
		...
		return <div className="ltn__upcoming-project-area section-bg-1--- bg-image-top pt-115 pb-65" style={{ backgroundImage: "url(/assets/img/bg/22.jpg)" }}>
			<div className="container">
				...
				<Slider {...setting} className="row ltn__upcoming-project-slider-1-active slick-arrow-3">
								...
								<div className="col-lg-5 section-bg-1">
									<div className="ltn__upcoming-project-info ltn__menu-widget">
										...
										<div className="btn-wrapper animated go-top">
											<Link href="/contact" className="theme-btn-1 btn btn-effect-1">Download Brochure</Link>
										</div>
									</div>
								</div>
							</div>
